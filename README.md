...
# Como organizar projetos em React - Matheus Castiglioni

```create-react-native-web-app estrutura```

## Links Fontes
- https://imasters.com.br/front-end/como-organizar-projetos-em-react
- https://github.com/mahenrique94
